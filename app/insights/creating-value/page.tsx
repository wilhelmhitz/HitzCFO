...
>
  Principales mensajes
            ...
            >
              <li>1. Crear valor es la verdadera función del Director General.</li>
              <li>2.	El liderazgo consiste en desarrollar la capacidad de decidir de los demás.</li>
              <li>3.	El Director General construye el futuro mientras la organización gestiona el presente.</li>
              <li>4.	La transformación empresarial sostenible exige alinear estrategia, personas y ejecución.</li>
              <li>5.	La actividad no es progreso; solo crea valor aquello que fortalece las capacidades de la organización.</li>
              <li>6.	Las mejores organizaciones dependen de sistemas, cultura y personas, no de héroes individuales.</li>
              <li>7.	El legado de un Director General es dejar una empresa mejor preparada para el futuro.</li>
            </ol>
          </div>
...
>
  Sobre el autor
            ...
            <p>
            Wilhelm Hitz es Director General con más de treinta años de experiencia liderando organizaciones multinacionales y empresas familiares. Su trayectoria se ha centrado en la creación de valor, la transformación empresarial y el desarrollo de organizaciones de alto rendimiento.
            </p>
          </div>
